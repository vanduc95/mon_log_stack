...
Inspire and combine from [dockprom](https://github.com/stefanprodan/dockprom) + [EFK stack](https://github.com/giefferre/EFK-stack)
...
* Kibana is exposed on port `http://<host-ip>:5601`
